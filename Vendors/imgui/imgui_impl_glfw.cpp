...
// See https://github.com/ocornut/imgui/issues/6034 and https://github.com/issues/1630
...
static int ImGui_ImplGlfw_TranslateUntranslatedKey(int key, int scancode)
{
    ...
    // See https://github.com/issues/1502 for details.
...
static bool ImGui_ImplGlfw_Init(GLFWwindow* window, bool install_callbacks, GlfwClientApi client_api)
{
    ...
    // Update monitors the first time (note: monitor callback are broken in GLFW 3.2 and earlier, see github.com/issues/784)
...
static void ImGui_ImplGlfw_UpdateMouseData()
{
    ...
    for (int n = 0; n < platform_io.Viewports.Size; n++)
    {
        ...
        // See https://github.com/issues/1236 if you want to help in making this a GLFW feature.
...
static void ImGui_ImplGlfw_UpdateMonitors()
{
    ...
    for (int n = 0; n < monitors_count; n++)
    {
        ...
        if (w > 0 && h > 0) // Workaround a small GLFW issue reporting zero on monitor changes: https://github.com/pull/1761
        {
...
static void ImGui_ImplGlfw_ShowWindow(ImGuiViewport* viewport)
{
    ...
    // See https://github.com/issues/1189
...
static LRESULT CALLBACK ImGui_ImplGlfw_WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_XBUTTONDOWN: case WM_XBUTTONDBLCLK: case WM_XBUTTONUP:
        ...
        // We have submitted https://github.com/pull/1568 to allow GLFW to support "transparent inputs".
